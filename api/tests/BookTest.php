...
class BookTest extends BaseTest
{
     ...
     * Reads a book.
     */
    public function testReadABook(): void
    {
        $this->markTestIncomplete("It's not easy to test item requests because of auto-increment IDs after fixture generation");
//        $response = $this->request('GET', '/books/1');
//        $json = json_decode($response->getContent(), true);
//
//        $this->assertArrayHasKey('title', $json);
//        $this->assertArrayHasKey('abstract', $json);
//        $this->assertArrayHasKey('isbn', $json);
